 ...
 * <td>Test choice value for the property of dimension with extended choice
 * </td>
 ...
 * <tr>
 * <td></td>
 * <td>Test integer value for the property of integer with extended choice
 * </td>
 * <td>getXXXValue() should return right result.</td>
 * </tr>
 * 
...
public class FactoryPropertyHandleTest extends BaseTestCase
{
	...
	public void testGetValues( ) throws DesignFileException, SemanticException
	{
		...
		FactoryPropertyHandle property = style
				.getFactoryPropertyHandle( Style.FONT_SIZE_PROP );
		...
		style.setStringProperty( Style.FONT_SIZE_PROP,
				"12" + design.getSession( ).getUnits( ) ); //$NON-NLS-1$
		...
		assertEquals(
				"12" + design.getSession( ).getUnits( ), property.getStringValue( ) ); //$NON-NLS-1$
		...
		String color = style.getFactoryPropertyHandle( Style.COLOR_PROP )
				.getColorValue( );
		assertEquals( "red", color ); //$NON-NLS-1$

		boolean isStyleProperty = style.getFactoryPropertyHandle(
				Style.COLOR_PROP ).isStyleProperty( );
